...
WebTop ist eine voll funktionsfähige Groupwarelösung welche auf dem ActiveSync Protokoll basiert.

Die Weboberfläche erreicht man über: ``https://<server_name>/webtop``.
...
Für den Zugriff auf die Webapplikation braucht man nur Benutzername und Passwort, auch wenn mehrere Domänen eingerichtet sind. 

**Beispiel**

* Servername: mymail.mightydomain.com
* Weitere E-Mail Domäne: baddomain.net
* Benutzername: goofy
* Login: goofy
...
Bei einem login über einen Active Sync Zugang meldet man sich wie folgt an <username>@<domäne> wobei ``<domäne>`` die Domäne des Serversis the 
Servers ist.

**Beispiel**

* Servername: mymail.mightydomain.com
* AWeitere E-Mail Domäne: baddomain.net
* Username: goofy
* Login: goofy@mightydomain.com

Wenn der Zugriff über ein Active Sync Konto eingerichtet wird bitte beachten dass das nur der Servername ohne Domäne angegeben wird.


.. note::
   Active Sync wird nur für Android und iOS Geräte unterstützt.
   Outlook wird nicht unterstützt.
   E-Mail Synchronisation wird aktuell nicht unterstützt.
